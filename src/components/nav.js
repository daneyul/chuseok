      ...
      <div className="container">
        <div id="nav-list" className="row justify-content-between">
          ...
          <ul className="col-6 col-md-4 nav-item nav-middle active">
            <a href="/" onClick="window.location.reload();"><li className="nav-item--center">Chuseok 2025</li></a>
          </ul>
          ...
          <ul className="col-4 nav-item justify-content-between nav-sides">
            ...
            <li className="nav-dropdown--parent">
              <span>
                <a href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fchuseok.info&text=Celebrate%20Chuseok%202520%21%20Learn%20about%20the%20Korean%20harvest%20festival." target="_blank" rel="noopener noreferrer"><img src={s1} alt="Share on Twitter" className="social-icons--first" /></a>
