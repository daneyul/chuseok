...
<div class="footer-bg footer-font">
    ...
    <div class="row footer-color justify-content-lg-between flex-wrap">
        <div class="col-12 footer-top">
            ...
            <h4 class="footer-font">&copy; 2019 All Rights Reserved <a href="/privacy-policy" class="footer-font footer-color footer-underline footer-link">Privacy Policy</a></h4>
        </div>
