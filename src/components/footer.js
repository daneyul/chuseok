...
<div class="footer-bg footer-color">
    ...
    <div class="row justify-content-lg-between flex-wrap">
        <div class="col-12 footer-top">
            <h3 class="footer-title">Chuseok 2023</h3>
            <h4 class="footer-font">&copy; 2023 All Rights Reserved <a href="/privacy-policy" class="footer-font footer-color footer-underline footer-link">Privacy Policy</a></h4>
        </div>
