    ...
    <div class="container nav-space">
      ...
      <div class="row justify-content-start landing-title3--margin">
        <div class="col-12">
          ...
          <h4 class="text-left landing-title3 header-mt"><a href="https://english.visitkorea.or.kr/enu/AKR/FU_EN_15.jsp?cid=2615334" target="_blank" rel="noopener noreferrer" class="header-box">Looking for KTX and SRT railway dates during Chuseok? Click here!</a></h4>
        </div>
      </div>
      </div>
